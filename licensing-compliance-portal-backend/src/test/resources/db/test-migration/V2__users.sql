...
INSERT INTO users (id, email, password_hash, role, full_name, organisation) VALUES
  ...
  ('7a94b975-1166-4335-8a15-91dba4d1005a', 'committee@bnr.rw',        '$2y$12$hyvXuJhCT0tcGuwexT.LM.o.TuSRnZmnyzYOL1Ii2TAPGyeRiBNzK', 'LICENSING_COMMITTEE',    'Dr. Diane Kamanzi',      'BNR Board Committee'),
  ('cd738318-8086-48fc-a894-1749f93a922c', 'governor.delegate@bnr.rw','$2y$12$hyvXuJhCT0tcGuwexT.LM.o.TuSRnZmnyzYOL1Ii2TAPGyeRiBNzK', 'GOVERNOR_DELEGATE',      'Prof. John Rwangombwa',  'BNR Executive'),
